...
export default function Register() {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center p-4 bg-white">
            <div className="w-full max-w-md rounded-lg border border-[#d0d0d0] p-8">
                <h1 className="mb-8 text-center text-2xl font-semibold text-black">Create New Account</h1>
                ...
                <form className="space-y-6">
                    ...
                    <div className="mt-4 text-center">
                        ...
                        <a href="/login" className="text-[#916bbf] hover:underline">
                            Login
                        </a>
                    </div>
                </form>
