...
import TableArtist from '../../components/admin/TableArtist'
                ...
                <table className="w-full border-collapse">
                    <thead>
                        <tr className="border-b border-[#292929]">
                            ...
                            <th className="py-3 text-left font-medium">Tên nghệ sĩ</th>
                            <th className="py-3 text-left font-medium">Quốc gia</th>
                            <th className="py-3 text-left font-medium">số bài hát</th>
                            <th className="py-3 text-left font-medium">số album</th>
                            <th className="py-3 text-left font-medium">Ngày tạo</th>
                            <th className="py-3 text-left font-medium"></th>
                        </tr>
                    </thead>
                    <Suspense fallback={<Loading />}>
                        <TableArtist query={query} />
                    </Suspense>
                </table>
            </div>
        </div>
