  ...
  return (
    <div className=" bg-[#020202] text-white w-full">
      ...
      <div className="relative w-full h-[300px] md:h-[400px]">
        <div
          className="absolute inset-0 bg-gradient-to-b from-transparent to-[#020202] z-10 bg-cover bg-center bg-no-repeat brightness-50"
          style={{
            backgroundImage:
              "url('https://static.wixstatic.com/media/8796a2_0351b51be6f047d8885d9fba3327f781~mv2.jpg/v1/fill/w_980,h_551,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/8796a2_0351b51be6f047d8885d9fba3327f781~mv2.jpg')",
          }}
        ></div>
        <div className="relative z-20 w-full px-4 sm:px-8 md:px-16 lg:px-24 pt-24 md:pt-32 lg:pt-48">
          ...
          <p className="text-sm text-[#d4d4d8] max-w-2xl mb-2">
            {name || "hay còn gọi là Trần sơn "}, được biết đến với nghệ danh
            Datmaniac, là rapper...
          </p>
          <button className="text-[#f31260] text-sm hover:underline">
            xem thêm
          </button>
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            ...
            {subscribe ? (
              <button
                ...
                className="flex items-center gap-2 border-[1px] border-white opacity-60 bg-gray-950 text-white px-4 py-2 rounded-full text-xs sm:text-sm"
              >
              ...
              <button
                onClick={handleSubscribe}
                className="flex items-center gap-2 bg-[#f31260] hover:bg-[#f31260]/80 text-white px-4 py-2 rounded-full text-xs sm:text-sm"
              >
                <span>Đăng ký</span>
        ...
        <div className="space-y-2">
          {[1, 2, 3, 4].map((index) => (
            <Link
              ...
              key={index}
              onClick={setIsPlay}
              className="flex items-center justify-between hover:bg-white/5 rounded-md pr-3"
            >
